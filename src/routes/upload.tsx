      ...
      <div className="mx-auto max-w-4xl space-y-6 p-5 md:p-8">
        ...
        >
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            or paste your raw notes below — works either way
          </p>
        ...
        <div className="space-y-4 rounded-3xl border border-border bg-card p-6">
          <input
            ...
            placeholder="Subject name (e.g. JAMB Biology)"
          ...
          <textarea
            ...
            rows={8}
            placeholder="Paste raw lecture notes here..."
              ...
              <ol className="mt-4 divide-y divide-border">
                {topics.map((t, i) => (
                  <li key={i} className="flex items-center gap-4 py-3">
                    <span className="grid h-8 w-8 place-items-center rounded-full bg-muted font-mono text-xs">
                      0{i + 1}
                    </span>
